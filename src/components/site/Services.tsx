/**
 * @fileoverview Services Component (Self-fetching)
 * @description API'den hizmet verilerini çeken standalone bileşen.
 * Skeleton loading, error handling, ve accessibility desteği ile.
 *
 * @example
 * <Services />
 */
...
/**
 * Services Component (Self-fetching)
 * @param limit Maximum number of services to display
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <Link
              href="/iletisim"
              className="inline-flex items-center gap-2 mt-6 rounded-xl bg-emerald-500 px-6 py-3 text-white font-medium shadow-lg shadow-emerald-500/30 transition-all hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-500/50"
              aria-label="Bize ulaşın sayfasına git"
            >
